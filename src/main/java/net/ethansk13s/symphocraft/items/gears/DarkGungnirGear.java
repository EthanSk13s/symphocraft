...
public class DarkGungnirGear extends ArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public DarkGungnirGear(EquipmentSlot slot, Settings settings) {
        super(AllGearMaterial.DARK_GUNGNIR, slot, settings);
    }
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		...
		event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.dark_gungnir.idle", true));
